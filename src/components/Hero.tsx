...
import heroImg from "../../public/img/hero-1.jpg";

export const Hero = () => {
  return (
    <>
      <Container className="flex flex-wrap lg:pt-0">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              HVAC & Air Filtration Solutions, Built for Better Air
            </p>

            <div className="flex flex-col items-center lg:items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              <a
                href="/company-profile.pdf"
                target="_blank"
                rel="noopener"
                className="btn-primary px-8 py-4 text-center text-lg font-medium"
              >
                Learn more
              </a>
              {/* <a
